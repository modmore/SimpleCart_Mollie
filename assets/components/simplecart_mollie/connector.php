<?php
/**
 * SimpleCart Mollie Connector
 *
 * @package simplecart_mollie
...
$corePath = $modx->getOption('simplecart_mollie.core_path', null, $modx->getOption('core_path') . 'components/simplecart_mollie/');
require_once $corePath . 'model/simplecart_mollie/simplecart_mollie.class.php';

$modx->simplecart_mollie = new simplecart_mollie($modx);
...
/* handle request */
$path = $modx->getOption($cp, $modx->simplecart_mollie->config, $corePath . 'processors/') . (($validWebAction) ? 'web/' : '');
